...
SOA004Client = {
//    _XRESTURI: "http://bolsrv0138.boliden.internal:7802/SOA004/rest/BI/",
	_RESTURI: "http://xxx.boliden.internal:4081/",
	_AUTHSTR: "test",
	AJAX: null,
	system: "",
	dataobject: "",
	seturi: function (){
		var url = location.href;
 		if ( url.indexOf("bolsrv0406") > -1 ) {
			this._RESTURI = "http://bolsrv0461.boliden.internal:4081/";
		} else if ( url.indexOf("file") > -1 ) {
			this._RESTURI = "http://bolsrv0461.boliden.internal:4081/";
		}
		consolelog("seturi<"+this._RESTURI+"> : <" + url+">");
  },
